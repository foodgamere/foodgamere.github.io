...
function getCustomChefsOptions(e, a, t) {
    ...
    for (var h in f) {
        ...
        var isOwned = f[h].got || isAllUltimateMode || (configUltimatedIds.allSet && configUltimatedIds.allSet[chefIdStr]);
                                            ...
                                            if (i) {
                                                ...
                                                if (a && a.chefs) {
                                                    for (var ac in a.chefs)
                                                        if (a.chefs[ac].id == e[ch].chefId && a.chefs[ac].got) {
                                                            chefGot = !0;
                                                            break
                                                        }
                                                } else if (e[ch].got || !e[ch].hide) {
            ...
            if (hasValidSkill) {
                ...
                if (localData && localData.chefs) {
                    for (var lci = 0; lci < localData.chefs.length; lci++) {
                        if (localData.chefs[lci].id == e[t].chefId && "是" == localData.chefs[lci].ult) {
                            l.isUltimated = true;
                            break;
                        }
                    }
