...
function reInitChefTable(e) {
    ...
    o.MakeCellsEditable({
        ...
        onUpdate: function(a, t, i, l) {
            ...
            28 != i.index().column && 31 != i.index().column || i.data() == l || ($("#chk-setting-auto-update").prop("checked") ? updateRecipeChefTable(e) : $("#btn-chef-recal").closest(".inline-wrapper").removeClass("hidden")),
                ...
                if ("S" == t.ret) {
                    ...
                    if (i) {
                        ...
                        try {
                            ...
                            console.log("loadUltimate error:", err)
                        }
                    } else {
                        $.popupmsg({
                            message: "导入失败 !",
