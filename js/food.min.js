...
function loadCalRule(e) {
    ...
    if (calCustomRule.isGuestRate) {
        ...
        if (isMobile) {
            ...
            // 桌面版时，确保开关在原位置
            $("#cultivation-mode-switch-wrapper").insertAfter("#btn-cal-clear-selected");
            $("#mobile-mode-switch-container").hide();
        }
        // 根据当前模式显示对应的查询UI
        ...
        // 隐藏模式切换开关，并移回原位置
        $("#cultivation-mode-switch-wrapper").addClass("hidden").insertAfter("#btn-cal-clear-selected");
        // 正常营业模式显示调料选择框
        $(".condiment-box").removeClass("hidden");
        // 正常营业模式显示菜谱调料选择框
        $("#chk-cal-recipe-condiment").closest(".select-wrapper").removeClass("hidden");
