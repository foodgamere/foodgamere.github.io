    ...
    setTimeout(function() {
        ...
        for (var k in e.recipes) {
            ...
            if (timeAddition !== 0) {
                ...
                var timeFactor = 1 + (timeAddition / 100);
...
function setPartialUltimateOptions(e) {
    ...
    for (var t in skillTypeChefs) {
        var s = "<option value='" + skillTypeChefs[t].chef.chefId + "' data-subtext='" + skillTypeChefs[t].disp.replace(/<br>/g, " ") + "' class='chef-skill-type'>" + skillTypeChefs[t].chef.name + "</option>";
        $("#chk-chef-partial-ultimate").append(s);
    }
    for (var t in timeTypeChefs) {
        var s = "<option value='" + timeTypeChefs[t].chef.chefId + "' data-subtext='" + timeTypeChefs[t].disp.replace(/<br>/g, " ") + "' class='chef-time-type'>" + timeTypeChefs[t].chef.name + "</option>";
        $("#chk-chef-partial-ultimate").append(s);
    }
    ...
    for (var t in skillTypeChefs) {
        var s = "<option value='" + skillTypeChefs[t].chef.chefId + "' data-subtext='" + skillTypeChefs[t].disp.replace(/<br>/g, " ") + "'>" + skillTypeChefs[t].chef.name + "</option>";
        $("#chk-cal-partial-ultimate").append(s);
    }
    for (var t in timeTypeChefs) {
        var s = "<option value='" + timeTypeChefs[t].chef.chefId + "' data-subtext='" + timeTypeChefs[t].disp.replace(/<br>/g, " ") + "'>" + timeTypeChefs[t].chef.name + "</option>";
        $("#chk-cal-partial-ultimate").append(s);
    }
}
