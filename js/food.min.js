...
function reInitRecipeTable(e) {
    ...
    o.MakeCellsEditable({
        ...
        onUpdate: function(a, t, i, l) {
            ...
            32 == i.index().column && i.data() != l && ($("#chk-setting-auto-update").prop("checked") ? updateRecipeChefTable(e) : $("#btn-recipe-recal").closest(".inline-wrapper").removeClass("hidden")),
...
function reInitChefTable(e) {
                            ...
                            if (5 == l) {
                                ...
                                if (12 == l) {
                                    ...
                                    if (17 == l) {
                                        ...
                                        i += "<div class='col-lg-3 col-xs-6'><span class='child-key'>" + t[l].title + (l < 3 ? "" : "：") + "</span><span class='child-value'>" + (t[l].data ? t[l].data : 19 == l ? "无" : 22 == l || 23 == l ? "否" : "") + "</span></div>"
                                }
                            }
                        }
    ...
    o.MakeCellsEditable({
        ...
        onUpdate: function(a, t, i, l) {
            ...
            26 != i.index().column && 29 != i.index().column || i.data() == l || ($("#chk-setting-auto-update").prop("checked") ? updateRecipeChefTable(e) : $("#btn-chef-recal").closest(".inline-wrapper").removeClass("hidden")),
...
function initDecorationTable(e) {
    ...
    for (var o in e.suits)
        n += "<option value='" + e.suits[o].name + "'>" + e.suits[o].name + "</option>";
    $("#select-decoration-suit").append(n).selectpicker().change(function() {
...
function generateChefsExportData() {
    ...
    for (var t in a) {
        ...
        i.got = a[t].got,
        i.ult = a[t].ultimate,
        a[t].equip && (i.equip = a[t].equip.equipId),
        1 != a[t].disk.level && (i.dlv = a[t].disk.level);
        var l = !1
          , s = [];
        for (var c in a[t].disk.ambers) {
            var r = a[t].disk.ambers[c].data;
            r ? (s.push(r.amberId),
            l = !0) : s.push(0)
        }
        l && (i.ambers = s),
...
function initCalTables(e, a) {
    console.log("initCalTables called");
    calCustomRule = {},
    calCustomRule.id = 0,
            ...
            if (t && t.rules && t.rules.length > 0) {
                ...
                if (i.length > 0) {
                    for (var l = i.length - 1; l >= 0; l--)
                        e.rules.unshift(i[l]);
                    var r = $("#select-cal-rule optgroup[label='活动及厨神']");
                    r.length || ($("#select-cal-rule").prepend("<optgroup label='活动及厨神'></optgroup>"))
                }
            }
...
function loadHistoryRules(e) {
    if (historyRulesData && historyRulesData.length > 0) {
        ...
        var historyGroup = $("<optgroup label='历史规则'></optgroup>");
...
function fetchHistoryRules() {
    console.log("fetchHistoryRules called");
    $.ajax({
    ...
    $.ajax({
        ...
        success: function(t) {
            if (t && t.rules && t.rules.length > 0) {
                ...
                if (callback) callback(t.rules[0]);
            }
        },
        error: function() {
            alert("加载历史规则详情失败");
...
function initCalRulesLocal(e, a) {
        ...
        if (!e.rules[t].Hide && e.rules[t].Id) {
            ...
            if (!(i && s < i || l && s > l)) {
                ...
                if (e.rules[t].isNetworkRule) {
                    var o = $("#select-cal-rule optgroup[label='活动及厨神']");
                    o.length || ($("#select-cal-rule").prepend("<optgroup label='活动及厨神'></optgroup>"),
                    o = $("#select-cal-rule optgroup[label='活动及厨神']"));
    ...
    if ($("#select-cal-rule").selectpicker().change(function() {
...
function loadUltimate(e, a) {
    var t = getLocalData()
      ...
      , l = i.global;
    for (var s in l)
        "Stirfry" != l[s].type || l[s].tag ? "Boil" != l[s].type || l[s].tag ? "Knife" != l[s].type || l[s].tag ? "Fry" != l[s].type || l[s].tag ? "Bake" != l[s].type || l[s].tag ? "Steam" != l[s].type || l[s].tag ? 1 != l[s].tag ? 2 != l[s].tag ? "MaxEquipLimit" != l[s].type || 1 != l[s].rarity ? "MaxEquipLimit" != l[s].type || 2 != l[s].rarity ? "MaxEquipLimit" != l[s].type || 3 != l[s].rarity ? "MaxEquipLimit" != l[s].type || 4 != l[s].rarity ? "MaxEquipLimit" != l[s].type || 5 != l[s].rarity ? "UseAll" != l[s].type || 1 != l[s].rarity ? "UseAll" != l[s].type || 2 != l[s].rarity ? "UseAll" != l[s].type || 3 != l[s].rarity ? "UseAll" != l[s].type || 4 != l[s].rarity ? "UseAll" != l[s].type || 5 != l[s].rarity ? "Material_Gain" != l[s].type && "Material_Vegetable" != l[s].type && "Material_Meat" != l[s].type && "Material_Fish" != l[s].type && "Material_Creation" != l[s].type && "ExperienceTimeRate" != l[s].type && "GoalOpeningTimeAdd" != l[s].type && "TimeChickenSeconds" != l[s].type && console.log(l[s].type) : $("#input-cal-ultimate-5-price").val(l[s].value) : $("#input-cal-ultimate-4-price").val(l[s].value) : $("#input-cal-ultimate-3-price").val(l[s].value) : $("#input-cal-ultimate-2-price").val(l[s].value) : $("#input-cal-ultimate-1-price").val(l[s].value) : $("#input-cal-ultimate-5-limit").val(l[s].value) : $("#input-cal-ultimate-4-limit").val(l[s].value) : $("#input-cal-ultimate-3-limit").val(l[s].value) : $("#input-cal-ultimate-2-limit").val(l[s].value) : $("#input-cal-ultimate-1-limit").val(l[s].value) : $("#input-cal-ultimate-female-skill").val(l[s].value) : $("#input-cal-ultimate-male-skill").val(l[s].value) : $("#input-cal-ultimate-steam").val(l[s].value) : $("#input-cal-ultimate-bake").val(l[s].value) : $("#input-cal-ultimate-fry").val(l[s].value) : $("#input-cal-ultimate-knife").val(l[s].value) : $("#input-cal-ultimate-boil").val(l[s].value) : $("#input-cal-ultimate-stirfry").val(l[s].value);
    var c = i.partial
      , r = [];
    for (var s in c)
        r.push(c[s].chefId);
...
function calCustomResults(e) {
    for (var a = 0, t = 0; t < calCustomRule.rules.length; t++) {
        ...
        // 然后更新每个已选菜谱的max值，基于剩余食材
        for (var c in l) {
            for (var r in l[c].recipes)
                if (l[c].recipes[r].data) {
                    if (i.MaterialsLimit && calCustomRule.materialsAll) {
                        var remain = getRemainMaterials(t, c, r);
                        var maxWithLimit = calculateMaterialLimit(remain, l[c].recipes[r].data, l[c].chef);
                        var recipeMax = getRecipeQuantity(l[c].recipes[r].data, i.materials, i, l[c].chef);
                        maxWithLimit = Math.min(maxWithLimit, recipeMax);
                        if (i.DisableMultiCookbook) {
                            maxWithLimit = Math.min(maxWithLimit, 1);
                        }
                        l[c].recipes[r].max = maxWithLimit;
                    } else {
                        // 重新计算max，考虑厨师的心法盘效果
                        l[c].recipes[r].max = getRecipeQuantity(l[c].recipes[r].data, i.materials, i, l[c].chef);
                    }
                    // 统一在这里调整quantity，确保不超过max
                    if (l[c].recipes[r].quantity > l[c].recipes[r].max) {
                        l[c].recipes[r].quantity = l[c].recipes[r].max;
                    }
                }
        }
        ...
        for (var c in l)
            for (var r in l[c].recipes)
                if (l[c].recipes[r].data) {
                    ...
                    if (i.MaterialsLimit) {
                        var remain = getRemainMaterials(t, c, r);
                        D = calculateMaterialLimit(remain, l[c].recipes[r].data, l[c].chef);
                        var recipeMax = getRecipeQuantity(l[c].recipes[r].data, i.materials, i, l[c].chef);
                        D = Math.min(D, recipeMax);
                        if (i.DisableMultiCookbook) {
                            D = Math.min(D, 1);
                        }
                        l[c].recipes[r].max = D;
                    ...
                    // 确保quantity不超过max
                    if (l[c].recipes[r].quantity > D) {
                        l[c].recipes[r].quantity = D;
                    }
                    var x = getRecipeQuantity(l[c].recipes[r].data, y.materials, i, l[c].chef);
                    var C = D - l[c].recipes[r].quantity;
                    x > C && (x = C);
                    var w = $(".cal-custom-item:eq(" + t + ") .selected-item:eq(" + c + ") .recipe-box:eq(" + r + ") .recipe-quantity");
                    w.find("input").attr("max", D).val(l[c].recipes[r].quantity),
                    w.find(".max").html(l[c].recipes[r].max),
        ...
        if (i.showTime) {
            var P = 0;
            for (var c in l)
                if (l[c].chef.chefId && (i && i.hasOwnProperty("DisableChefSkillEffect") && 0 != i.DisableChefSkillEffect || (P += getTimeAddition(l[c].chef.specialSkillEffect)),
                (!i || !i.hasOwnProperty("DisableEquipSkillEffect") || 0 == i.DisableEquipSkillEffect) && l[c].equip && l[c].equip.effect)) {
        ...
        if ((!l || x.data.got) && !(s.length > 0 && s.indexOf(x.data.rarity.toString()) < 0)) {
            ...
            if (!(n.length > 0 && n.indexOf(x.data.condiment) < 0)) {
                ...
                if (u.MaterialsLimit && calCustomRule.materialsAll) {
                    ...
                    var materialMaxS = calculateMaterialLimit(remainForThis, x.data, h[a].chef);
                ...
                for (var b in h)
                    for (var v in h[b].recipes)
                        if (h[b].recipes[v].data) {
                            ...
                            if (I += M.totalScore,
                            b == a && v == t && (M = getRecipeResult(h[b].chef, h[b].equip, h[b].recipes[v].data, h[b].recipes[v].max, h[b].recipes[v].max, u.materials, u, u.decorationEffect, h[b].recipes[v].useCondiment ? h[b].condiment : null, !0, h[b].recipes, q[3 * b + Number(v)], E[3 * b + Number(v)]),
                            R = M.totalScore,
                            N = M.efficiency,
                            0 == M.rankVal)) {
                ...
                if (u.hasOwnProperty("MaterialsNum")) {
                    ...
                    "分数" == o ? (w.content += "<span class='score'>" + R + "</span><span class='total'>" + I + "</span>",
                    w.order = I) : "时间" == o ? (w.content += "<span class='score'>" + x.data.totalTimeDisp + "</span>",
                    w.order = x.data.totalTime) : "效率" == o && (w.content += "<span class='score'>" + N + "</span>",
                    w.order = N);
...
function updateRecipeChefTable(e) {
    $(".loading").removeClass("hidden"),
    setTimeout(function() {
        e = getUpdateData(e),
        updateRecipeTableData(e),
...
function getUpdateData(e) {
    ...
    for (var o in e.chefs)
        setDataForChef(e.chefs[o], e.chefs[o].equip, i, c.global, n, c.self, null, t, null, l);
        ...
        if (t && (e[r].ultimateSkillList || e[r].ultimateSkillEffect)) {
            ...
            if (n && e[r].ultimateSkillList && skills) {
                for (var u in e[r].ultimateSkillList) {
                    ...
                    if (skillObj && skillObj.isQiXiaJiFa) {
                        var hasUlt = !1;
                        if (i) {
                            if (a)
                                for (var o in a.chefs)
...
function setPartialUltimateOptions(e) {
    ...
    for (var t in a.sort(function(e, a) {
    ...
    a) {
        var s = "<option value='" + a[t].chef.chefId + "' data-subtext='" + a[t].disp.replace(/<br>/g, " ") + "'>" + a[t].chef.name + "</option>"
          , c = !1;
        for (var r in a[t].effect)
            if ("Partial" == a[t].effect[r].condition && ("Bake" == a[t].effect[r].type || "Steam" == a[t].effect[r].type || "Boil" == a[t].effect[r].type || "Fry" == a[t].effect[r].type || "Knife" == a[t].effect[r].type || "Stirfry" == a[t].effect[r].type)) {
                c = !0;
                break
            }
        c && $("#chk-chef-partial-ultimate").append(s),
...
function setSelfUltimateOptions(e) {
    for (var a in e)
        for (var t in e[a].ultimateSkillEffect) {
            ...
            if ("Self" == i.condition && "Material_Gain" != i.type && "GuestDropCount" != i.type && "GuestApearRate" != i.type) {
...
function changeSelectStyle(e) {
    0 == $(e).val().length ? $(e).selectpicker("setStyle", "btn-info", "remove") : $(e).selectpicker("setStyle", "btn-info", "add")
}
...
function initChefShow() {
    ...
    for (i = $("#chk-chef-show option[value=17]").is(":selected"),
    t = 18; t <= 22; t++)
        changeTableHeaderClass(e, t, i);
...
function getInputHtml(e, a, t, i, l) {
    ...
    case "list":
        ...
        break;
    default:
        r.html = "<input class='form-control' value='" + i + "'></input>"
    }
    return r
}
...
var calCustomRule, private = !1, isMobile = !1, expendBtn = !0;
