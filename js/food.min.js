...
function getUpdateData(e) {
    ...
    for (var o in e.chefs) {
        if (!e.chefs[o].originalEquip) {
            e.chefs[o].originalEquip = e.chefs[o].equip;
            e.chefs[o].originalEquipId = e.chefs[o].equipId;
            e.chefs[o].originalEquipDisp = e.chefs[o].equipDisp;
        }
        var equipToUse = selectedEquip ? selectedEquip : e.chefs[o].originalEquip;
        e.chefs[o].equip = equipToUse;
        e.chefs[o].equipId = equipToUse ? equipToUse.equipId : e.chefs[o].originalEquipId;
        e.chefs[o].equipDisp = equipToUse ? equipToUse.disp : e.chefs[o].originalEquipDisp;
        setDataForChef(e.chefs[o], equipToUse, i, c.global, n, c.self, null, t, null, l);
    }
...
function setPartialUltimateOptions(e) {
    ...
    a) {
        ...
        for (var r in a[t].effect)
            if (("Partial" == a[t].effect[r].condition || "Next" == a[t].effect[r].condition) && ("Bake" == a[t].effect[r].type || "Steam" == a[t].effect[r].type || "Boil" == a[t].effect[r].type || "Fry" == a[t].effect[r].type || "Knife" == a[t].effect[r].type || "Stirfry" == a[t].effect[r].type)) {
                c = !0;
                break
            }
...
function initChefShow() {
    ...
    i ? $(".chef-material-combo-wrapper").show() : $(".chef-material-combo-wrapper").hide();
    for (i = $("#chk-chef-show option[value=18]").is(":selected"),
    t = 18; t <= 23; t++)
        changeTableHeaderClass(e, t, i);
...
function updateChefMaterialComboColumn() {
    ...
    if (a) {
        ...
        var i = t[a] || a;
        e.column(16).header().innerHTML = "采集类型-" + i;
        ...
        e.column(16).header().innerHTML = "采集类型";
        e.rows().every(function(index) {
            var row = this.data();
            row.materialCombo = "";
            this.data(row);
